...
<?php
 if ($ok != 2)
  {
  echo '<div class="list">Không có sản phẩm nào. <a href="/Sales-Website-PHP-main/Source/index.php">Quay lại cửa hàng</a> để tiếp tục mua sắm.</div></div>';
  ...
  while ($row = mysqli_fetch_array($query)) {
    ...
    echo'<form action="/Sales-Website-PHP-main/Source/giohang/index.php?mod=update&id='.$row['MaSanPham'].'" method="POST">';
?>
    ...
    echo '<td width="5%"style="border:1px solid #ebebeb; text-align: center;"><a href="/Sales-Website-PHP-main/Source/giohang/index.php?mod=xoa&id='.$row['MaSanPham'].'"><i class="far fa-trash-alt" aria-hidden="true" style="
    font-size: 25px;
...
"></i></a></td>';
  ...
  echo '<form action="/Sales-Website-PHP-main/Source/giohang/index.php?mod=thanhtoan" method="POST">';

  echo'<a class="submit" href="/Sales-Website-PHP-main/Source/index.php">Tiếp tục mua sắm</a>';
