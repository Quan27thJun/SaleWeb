...
if (isset($_GET["id"])) {
    ...
    $sql = "UPDATE sanpham
            ...
            if (mysqli_query($connection, $sql)) {
                echo "<div class='list'>Cập nhật sản phẩm thành công. <a href='/Sales-Website-PHP-main/Source/qlySanPham'>Quay lại</a></div>";
                exit;
            } else {
...
<div class="list">
<?php
echo '<form action="/Sales-Website-PHP-main/Source/qlySanPham/index.php?mod=update&id='.$id.'" method="POST" >';
?>
    <table>
        <tr>
            <td>
            ...
            <a href='/Sales-Website-PHP-main/Source/qlySanPham/index.php?mod=panel'>Quay lại</a></p>
    </form>
</div>
<?php
