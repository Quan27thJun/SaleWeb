...
// 2. Tạo câu truy vấn (Query): SELECT, INSERT, DELETE, UPDATE
    ...
    echo '<div class="tool"><a href="/Sales-Website-PHP-main/Source/qlyTaiKhoan/index.php?mod=sua&id='.$row['MaTaiKhoan'].'"><i class="far fa-edit">Update</i></a>  ';
    if($row['Xoa'] == 1) {
        echo '<a href="/Sales-Website-PHP-main/Source/qlyTaiKhoan/index.php?mod=khoiphuc&id='.$row['MaTaiKhoan'].'"><i class="fas fa-trash-restore-alt">Delete/Restore</i></a>';
    } else {
        echo '<a href="/Sales-Website-PHP-main/Source/qlyTaiKhoan/index.php?mod=xoa&id='.$row['MaTaiKhoan'].'"><i class="far fa-trash-alt">Delete/Restore</i></a>';
    }
    echo '</div></div>';
}
?>
