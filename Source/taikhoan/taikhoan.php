...
while($dsdonhang = mysqli_fetch_array($dsdh)) {
    ...
    echo '<td style="border:1px solid black; text-align: center;"><a href="/Sales-Website-PHP-main/Source/donhang/index.php?mod=chitiet&id='.$dsdonhang['MaDonDatHang'].'">Nhấp vào xem</a></td>';
    echo'</tr></td>';
    }
echo'</table>';
echo '<div class="info"><p  style="margin: 10px 20px 10px 20px;"><b>Thông tin của tôi</b></p>
    ...
    <p style="margin: 10px 20px 10px 20px;"><a href="/Sales-Website-PHP-main/Source/taikhoan/index.php?mod=capnhat&id='.$user['MaTaiKhoan'].'" class="submit3">Cập nhật thông tin</a></p>
    </div></div>';
